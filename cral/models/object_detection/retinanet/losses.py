...
def focal(alpha=0.25, gamma=2.0):
    ...
    def _focal(y_true, y_pred):
        """Compute the focal loss given the target tensor and the predicted
        tensor.

        As defined in https://arxiv.org/abs/1708.02002

        Args
            y_true: Tensor of target data from the generator with shape
                    (B, N, num_classes).
            y_pred: Tensor of predicted data from the network with shape
                    (B, N, num_classes).
...
def smooth_l1(sigma=3.0):
    ...
    Args
        sigma: This argument defines the point where the loss changes from
                L2 to L1.
